...
"""
============================================================================
Script 02: Population Genetics Analysis — MDS, Clustering, and Visualization
----------------------------------------------------------------------------
...
----------------------------------------------------------------------------
Description :
    This script reproduces all downstream population genetics analyses
    performed on the 2,434 x 2,434 IBS pairwise distance matrix output
    by PLINK. It generates all six publication-quality figures and two
    data tables used in the manuscript.

    Analyses performed:
    1. Multidimensional Scaling (MDS) from IBS distance matrix
    2. Population-level average distance computation
    3. Hierarchical clustering (average linkage)
    4. MDS scatter plots (Figures 1 and 4)
    5. Distance heatmap with clustering (Figure 2)
    6. Hierarchical clustering dendrogram (Figure 3)
    7. Geographic map with genetic proximity links (Figure 5)
    8. Within- and between-region distance boxplots (Figure 6)
    9. Publication-quality summary statistics table (Table 1)

Input files:
    - PCA.mdist         : 2,434 x 2,434 IBS distance matrix from PLINK
    - pcAinfo.xlsx      : Sample metadata (IID, GROUP, LABELS, COUNTRY,
                          LATITUDES, LONGITUDES)

Output files:
    - Figure1_MDS.png          : MDS scatter plot (all individuals)
    - Figure2_Heatmap.png      : Pairwise distance heatmap
    - Figure3_Dendrogram.png   : Hierarchical clustering dendrogram
    - Figure4_FocusPanel.png   : South Asian focus MDS panels
    - Figure5_GeoMap.png       : Geographic distribution map
    - Figure6_Boxplots.png     : Within/between region distance boxplots
    - Table1_Summary.png       : Population summary statistics (figure)
    - Raw_Analysis_Data.xlsx   : All raw analysis data (4 sheets)
    - mds_coordinates.csv      : MDS1/MDS2/MDS3 per individual
    - group_distances.csv      : 24 x 24 population pairwise distances

Software dependencies:
    numpy>=1.24, pandas>=2.0, scipy>=1.11, scikit-learn>=1.3,
    matplotlib>=3.7, seaborn>=0.12, openpyxl>=3.1, xlsxwriter>=3.1
...
Usage:
    ...
    Or simply run with default paths (same directory):
    python3 02_analysis_and_figures.py
============================================================================
"""
...
def main():
    ...
    print("=" * 60)
    print(" Population Genetics Analysis Pipeline")
    print(" South / West / Central Asian Populations")
    print("=" * 60)
